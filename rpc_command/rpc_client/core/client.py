...
class FibonacciRpcClient(object):
    def __init__(self):
        ...
        self.channel.basic_consume(self.callback_queue, #对列名
                                   self.on_response, #收到消息调用的函数
                                   auto_ack=True,
                                   )
        self.thread_list = [] #thread list
        self.result_lit = {} #result list
        self.complete = []
